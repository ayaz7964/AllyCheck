      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          ...
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Start New Scan
          </button>
        </div>
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
                  ...
                  {filteredViolations.map((issue, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Expanded */}
                        {isExpanded && (
                          <div className="mt-6 pt-6 px-6 pb-6 border-t border-gray-200 dark:border-gray-800 space-y-4">
                            {/* AI Explanation */}
                              ...
                              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-5 border border-gray-100 dark:border-gray-800">
                                <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                                  ...
                                  <button
                                    ...
                                    className="text-[10px] text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 uppercase font-bold focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  >
                                    📋 Copy
                                  </button>
                                </div>
      ...
      <footer className="mt-auto py-8 px-6 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
          <p>© 2025 AllyCheck. Powered by Gemini AI & axe-core.</p>
